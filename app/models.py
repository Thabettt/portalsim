...
class Internship(SQLModel, table=True):
    ...
    academic_supervisor_name: Optional[str] = Field(default=None, max_length=150)
    academic_supervisor_id: Optional[str] = Field(default=None, max_length=50)
    ...
    supervisor_job_title: Optional[str] = Field(default=None, max_length=150)
    supervisor_mobile: Optional[str] = Field(default=None, max_length=30)
    country: Optional[str] = Field(default=None, max_length=100)
    faculty: Optional[str] = Field(default=None, max_length=150)
    first_major: Optional[str] = Field(default=None, max_length=150)
    second_major: Optional[str] = Field(default=None, max_length=150)
    source_of_internship: Optional[str] = Field(default=None, max_length=100)
    workplace: Optional[str] = Field(default=None, max_length=100)
    departments: Optional[str] = Field(default=None, max_length=500)
    days_per_week: Optional[int] = Field(default=None, ge=1, le=7)
    hours_per_day: Optional[int] = Field(default=None, ge=1, le=24)
    entry_date: Optional[datetime] = Field(default=None, sa_column=Column(DateTime))
    proof_of_acceptance_uploaded_at: Optional[datetime] = Field(default=None, sa_column=Column(DateTime))
    evaluation_form_uploaded_at: Optional[datetime] = Field(default=None, sa_column=Column(DateTime))
    career_center_review_status: Optional[str] = Field(default=None, max_length=20)
    career_center_review_reason: Optional[str] = Field(default=None, max_length=1000)
    supervisor_review_status: Optional[str] = Field(default=None, max_length=20)
    supervisor_review_reason: Optional[str] = Field(default=None, max_length=1000)
    academic_final_status: Optional[str] = Field(default=None, max_length=20)
    career_center_final_status: Optional[str] = Field(default=None, max_length=20)
